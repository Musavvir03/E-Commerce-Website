...
import  {IMAGE_CDN_URL}  from "../utils/constant.js";
        ...
        <div className="menu-items" key={item.card.info?.id}>
          <div className="item-details">
            <div className="item-extras">
              ...
              {item.card.info?.itemAttribute?.vegClassifier === "NONVEG" ? <FaRegCaretSquareUp className="nonveg" size="1.25rem" /> : <FaRegStopCircle className="veg" size="1.25rem" />}
            ...
            <div className="item-img">
                {!item.card.info?.imageId ? null : <img src={IMAGE_CDN_URL + item.card.info?.imageId} /> }
